<template>
  <q-page class="flex flex-start justify-center inset-shadow">
    ...
    <div class="row justify-center items-center q-pb-xl">
      <q-btn class="q-px-md social" type="a" href="https://twitter.com/jgalbraith64" target="_blank" flat round color="primary" :icon="fabTwitter" size="md" />
      <q-btn class="q-px-md social" type="a" href="https://github.com/hawkeye64" target="_blank" flat round color="primary" :icon="fabGithub" size="md" />
      <q-btn class="q-px-md social" type="a" href="https://codepen.io/Hawkeye64" target="_blank" flat round color="primary" :icon="fabCodepen" size="md" />
      <q-btn class="q-px-md social" type="a" href="mailto:jeff@quasar.dev" target="_blank" flat round color="primary" :icon="farEnvelope" size="md" />
    </div>
