...
During the summer, we go camping -- a lot! Some consider it "glamping" (glorified camping) because we have a trailer and a lot of the time we go off-grid. You pull out to what's called "crown" or "public-use" land, pick a spot, set up your fire and you're camping. Usually so far remote from civilization there is no mobile services.
